 ...
 * живут здесь и переиспользуются: монотипный дивизион ссылается на модель
 * целиком, лодка дивизиона-списка — на свою
 * (@see ForeignRegattaYacht::spec()).
 *
...
class CharterYachtModel extends Model implements HasMedia
{
    ...
    /** Монотипные дивизионы, собранные из этой модели. */
    public function divisions(): HasMany
    {
        return $this->hasMany(ForeignRegattaDivision::class, 'yacht_model_id');
    }
