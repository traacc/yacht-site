...
<section class="py-10 bg-white">
    <div class="max-w-(--breakpoint-2xl) mx-auto">
        ...
        <div class="text-brand-gray font-medium">
            <div class="mb-8">
                <h4 class="a-font text-2xl text-[#2E325C] mb-4">01. Общие требования</h4>
