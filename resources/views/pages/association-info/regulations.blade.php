...
<section class="py-10 bg-white px-4 sm:px-6 lg:px-8 text-sm md:text-base">
    ...
    <div class="container mx-auto">
        ...
        <div class="text-brand-gray font-medium">
            <div class="mb-8">
                <p>К классу «Картер-30» относятся яхты, соответствующие чертежам проекта Д. Картера, польские яхты «Телига-89» и «Телига-91», а также яхты, построенные с использованием матриц этого проекта. </p>
            </div>
            <div class="mb-8">
                <p>Правила класса направлены на сохранение флота и поддержание сопоставимых технических характеристик яхт. </p>
            </div>
            <div class="mb-8">
                <p>Гонки класса проводятся по действительному времени прохождения дистанции, без применения гандикапа. </p>
            </div>
            <div class="mb-8">
                <p>К участию в зачете класса допускаются яхты, соответствующие требованиям правил и прошедшие установленную процедуру подтверждения соответствия. </p>
            </div>
            <div class="mb-8">
                <p>Правила устанавливают основные ограничения по корпусу, килю, рулевому устройству, рангоуту, такелажу, парусам, двигателю и оборудованию. </p>
            </div>
            <div class="mb-8">
                <p>Все изменения, влияющие на соответствие яхты классу, подлежат рассмотрению Техническим комитетом. </p>
            </div>
            <div class="mb-8">
                <p>Правила имеют открытый характер: все, что прямо не запрещено, допускается при соблюдении установленных ограничений.</p>
            </div>
            <div class="mb-8">
                <p>Соответствие яхт требованиям класса контролирует Технический комитет Ассоциации класса. </p>
            </div>
            <div class="mb-8">
                <p>Для участия в соревнованиях яхта должна иметь действующее мерительное свидетельство ORC и/или подтверждение соответствия классу.</p>
            </div>
            <div class="mb-8">
                <p>Ответственность за безопасность яхты, экипажа и исправность оборудования несет владелец яхты или капитан.</p>
            </div>
        </div>
    </div>
</section>
