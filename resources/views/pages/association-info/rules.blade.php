  ...
  <section class="container mx-auto md:mb-24 mb-8">
    ...
    <div class="order text-base md:text-lg">
      <ol class="list-decimal [&_a]:text-[#2D92CE] [&_a]:underline pl-6 space-y-5">
        ...
        <li>Все члены Ассоциации имеют право принимать участие в обсуждениях любых вопросов на официальных ресурсах Ассоциации, <a href="https://vk.com/carter_pro" target="_blank">Вконтакте</a> или <a href="https://t.me/a_carterpro" target="_blank">Телеграмм</a></li>
