...
desc="<p>За созданием <b>Carter PRO</b> стоят люди, для которых парусный спорт — это не просто соревнования, а часть жизни. Это владельцы яхт, спортсмены, организаторы регат и энтузиасты, объединённые общей целью — дать классу <b>Carter 30</b> новое развитие в России.</p>
<p>Команда ассоциации отвечает за стратегию, спортивное направление, технические стандарты, развитие сообщества и продвижение класса Carter 30 как современного и сильного монотипного флота.</p>" 
bgImage="{{ asset('images/bg/management.webp') }}" bgPosition="bottom"
>
