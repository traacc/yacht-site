...
<section class="py-12">
    <div class="max-w-(--breakpoint-2xl) mx-auto px-4 sm:px-6 lg:px-8 py-4 bg-[#F8F8F8]">
        ...
        <div class="grid md:grid-cols-2 gap-5">
            ...
            <div class="bg-brand-light rounded-xl p-5">
                        ...
                        <tbody class="divide-y text-center font-medium">
                            <template x-data="{ teams: [['Барс', 7.0], ['Барс', 7.0], ['Барс', 7.0]] }" x-for="(team, i) in teams" :key="i">
                                <tr>
                                    ...
                                    <td class="py-2" x-text="team[0]"></td>
                                    <td class="py-2" x-text="team[1]"></td>
                                </tr>
                            </template>
                        </tbody>
                    </table>
                        ...
                        <tbody class="divide-y text-center font-medium">
                            <template x-data="{ participants: [['Игорь Скалин', 7.0], ['Игорь Скалин', 7.0], ['Игорь Скалин', 7.0]] }" x-for="(p, i) in participants" :key="i">
                                <tr>
                                    ...
                                    <td class="py-2" x-text="p[0]"></td>
                                    <td class="py-2" x-text="p[1]"></td>
                                </tr>
                            </template>
                        </tbody>
                    </table>
...
<section class="py-12 bg-brand-light">
    <div class="max-w-(--breakpoint-2xl) mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('news') }}" wire:navigate class="text-[#2E325C] text-lg font-semibold hover:underline">Все новости →</a>
        </div>

        <div class="grid md:grid-cols-3 gap-6">
            <article class="bg-[#F8F8F8] overflow-hidden shadow-xs hover:shadow-md transition-shadow group">
                ...
                <div class="p-4">
                    <h3 class="font-semibold text-[#2E325C] text-lg mb-2">
                        Открыта регистрация на Кубок Carter 30 Pro
                    </h3>
                    <p class="font-medium text-brand-gray mb-3">Организаторы напоминают, что экипажи могут подать заявку с...</p>
                    <div class="mb-2 text-brand-gray-light">16 апреля 2026</div>
                    <div class="">
                        <a href="#" class="text-[#2E325C] text-lg font-semibold hover:underline">Читать далее →</a>
                    </div>
                </div>
            </article>
            ...
            <article class="bg-[#F8F8F8] overflow-hidden shadow-xs hover:shadow-md transition-shadow group">
                ...
                <div class="p-4">
                    ...
                    <p class="font-medium text-brand-gray mb-3">В расписание сезона добавлены даты старта, те самые, м...</p>
                    <div class="mb-2 text-brand-gray-light">9 апреля 2026</div>
                    <div class="">
                        <a href="#" class="text-[#2E325C] text-lg font-semibold hover:underline">Читать далее →</a>
                    </div>
                </div>
            ...
            <article class="bg-[#F8F8F8] overflow-hidden shadow-xs hover:shadow-md transition-shadow group">
                ...
                <div class="p-4">
                    ...
                    <p class="font-medium text-brand-gray mb-3">На сайте опубликованы обновлённые условия регистрации на...</p>
                    <div class="mb-2 text-brand-gray-light">2 апреля 2026</div>
                    <div class="">
                        <a href="#" class="text-[#2E325C] text-lg font-semibold hover:underline">Читать далее →</a>
                    </div>
                </div>
