<x-public-layout>
    ...
    <main class="main" x-data="{ team_modal_open: false, activeTeamIndex: null, entriesJson: @js($entriesJson) }">
        <section class="py-10 bg-white">
            <div class="container mx-auto bg-brand-light-bg flex flex-col md:flex-row gap-10 justify-between items-center">
                <div class="info">
                    ...
                    <x-regatta-external-id :value="$regatta->external_id" class="text-sm block pb-3" />
        ...
        @endif
        {{-- ===== О РЕГАТЕ ===== --}}
        @if(filled($regatta->description))
            <section class="py-10">
                <div class="container mx-auto">
                    <h2 class="section-title a-font text-brand-dark mb-8">О регате</h2>
                    <div class="prose max-w-none text-brand-gray text-lg leading-relaxed">
                        {!! $regatta->description !!}
                    </div>
                </div>
            </section>
                ...
                <table class="w-full bg-brand-light-bg">
                    <thead>
                        <tr class="md:text-2xl text-brand-dark border-b border-brand-border">
                            ...
                            <th class="pb-2 text-center font-medium a-font">
                                Разряд
