<div x-data="{
    ...
    <div x-show="isOpen"
        ...
        @elseif ($this->state === 'in-crew')
            ...
            <div class="py-4">
                @include('livewire.partials.regatta-entry-info')
        ...
        @elseif ($this->state === 'in-crew-captain')
            ...
            <div class="py-4">
                ...
                <div class="flex items-start gap-3 p-4 bg-yellow-50 border border-yellow-200 mb-5">
                    ...
                    <div>
                        <p class="text-sm font-medium text-yellow-800">Вы являетесь рулевым экипажа</p>
                        <p class="text-sm text-yellow-700 mt-1">Для отказа от участия необходимо сначала назначить другого рулевого в составе экипажа.</p>
                    </div>
                </div>
                <button type="button" @click="isOpen = false; $wire.closeModal()"
