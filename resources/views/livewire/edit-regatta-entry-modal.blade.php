        ...
        @elseif (! $authenticated)
            ...
            <form wire:submit.prevent="authenticate" class="space-y-4">
                <div>
                    ...
                    <input type="password" id="entry_edit_password" wire:model="password"
                           class="block w-full border bg-[#F8F8F8] rounded px-3 py-2 text-sm focus:border-[#2D92CE] focus:outline-none @error('password') border-red-300 @else border-gray-200 @enderror">
                    @error('password')
